 ...
 *  3. Create a new directory for your tests located at M1/src/tests/person2
 *  4. Now create a TestPerson2 Class and write methods to test add, subtract, multiply and divide
